...
void fromROS(const XmlRpc::XmlRpcValue& in, std::vector<ConstraintConfig>& out);
...
void fromROS(const std_msgs::Float64MultiArray& in, const std::vector<std::string>& joint_names, JointWeights& out);
