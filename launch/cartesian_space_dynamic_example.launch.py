...
def generate_launch_description():
    ...
    iiwa_controllers = PathJoinSubstitution([FindPackageShare('wbc_ros'), 'config', 'cartesian_space_dynamic_example', 'iiwa_controllers.yaml'])
    # Load the trajectory configuration file
    trajectory_publisher_config = os.path.join(get_package_share_directory('wbc_ros'),'config','cartesian_space_dynamic_example','trajectory_publisher.yml')
