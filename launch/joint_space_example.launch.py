...
def generate_launch_description():
    wbc_config            = os.path.join(get_package_share_directory('wbc_ros'),'config','joint_space_example','wbc.yml')
    joints_config         = os.path.join(get_package_share_directory('wbc_ros'),'config','joints.yml')
    joint_pos_ctrl_config = os.path.join(get_package_share_directory('wbc_ros'),'config','joint_space_example','joint_position_controller.yml')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            name='controller',
            parameters=[joint_pos_ctrl_config]
        ),
        Node(
            package='wbc_ros',
            namespace='wbc/'+task_name,
